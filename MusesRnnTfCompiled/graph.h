...
//   (arg0: f32[1,1,11]) -> (f32[1,1,256])
//
// Memory stats:
//   arg bytes total:    44
//   arg bytes aligned:  64
//   temp bytes total:   22636
//   temp bytes aligned: 22720
 ...
 public:
  ...
  static const tensorflow::XlaCompiledCpuFunction::StaticData& StaticData() {
    static XlaCompiledCpuFunction::StaticData* kStaticData = [](){
      ...
      data->set_raw_function(____graph);
  ...
  float& arg0(size_t dim0, size_t dim1, size_t dim2) {
    return (*static_cast<float(*)[1][1][11]>(
  ...
  const float& arg0(size_t dim0, size_t dim1, size_t dim2) const {
    return (*static_cast<const float(*)[1][1][11]>(
        arg_data(0)))[dim0][dim1][dim2];
  }
  ...
  float& result0(size_t dim0, size_t dim1, size_t dim2) {
    return (*static_cast<float(*)[1][1][256]>(
  ...
  const float& result0(size_t dim0, size_t dim1, size_t dim2) const {
    return (*static_cast<const float(*)[1][1][256]>(
        result_data(0)))[dim0][dim1][dim2];
  }

 private:
  // Number of buffers for the compiled computation.
  static constexpr size_t kNumBuffers = 15;
...
::tensorflow::cpu_function_runtime::BufferInfo({16ULL, ~0ULL}),
::tensorflow::cpu_function_runtime::BufferInfo({16ULL, ~0ULL}),
::tensorflow::cpu_function_runtime::BufferInfo({33ULL, ~0ULL}),
::tensorflow::cpu_function_runtime::BufferInfo({178ULL, 0ULL}),
::tensorflow::cpu_function_runtime::BufferInfo({180224ULL, ~0ULL}),
::tensorflow::cpu_function_runtime::BufferInfo({16ULL, ~0ULL}),
::tensorflow::cpu_function_runtime::BufferInfo({16ULL, ~0ULL}),
::tensorflow::cpu_function_runtime::BufferInfo({16ULL, ~0ULL}),
::tensorflow::cpu_function_runtime::BufferInfo({4097ULL, ~0ULL}),
::tensorflow::cpu_function_runtime::BufferInfo({16ULL, ~0ULL}),
::tensorflow::cpu_function_runtime::BufferInfo({4194304ULL, ~0ULL}),
::tensorflow::cpu_function_runtime::BufferInfo({4194304ULL, ~0ULL}),
::tensorflow::cpu_function_runtime::BufferInfo({4194304ULL, ~0ULL}),
::tensorflow::cpu_function_runtime::BufferInfo({16ULL, ~0ULL}),
::tensorflow::cpu_function_runtime::BufferInfo({86417ULL, ~0ULL})
      };
    return kBufferInfos;
  }
